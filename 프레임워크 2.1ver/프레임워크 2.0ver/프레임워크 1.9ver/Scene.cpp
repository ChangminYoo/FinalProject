...
void Scene::CreateGameObject()
{
	...
	DynamicObject.push_back(new CZombieObject(device, commandlist, XMFLOAT4(0, 90, 0, 0)));
	DynamicObject.push_back(new CZombieObject(device, commandlist, XMFLOAT4(0, 30, 0, 0)));
	DynamicObject.push_back(new CZombieObject(device, commandlist, XMFLOAT4(0,60, 0, 0)));
