...
void UpdateMD5Model(ID3D12GraphicsCommandList* m_DC,CMesh*& MD5Model, CGameObject* obj, float deltaTime, int animation,vector<ModelAnimation>& av, float scale=1);
