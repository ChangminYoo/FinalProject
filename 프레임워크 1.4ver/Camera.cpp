...
CCamera::CCamera(ID3D12Device* Device, ID3D12GraphicsCommandList* commandlist, float clientWidth, float clientHeight)
{
	SetPosition(0.0f, 70.0f, -100.0f);

	float aspect = 800.0f / 600.0f;

	SetLens(0.25f*MathHelper::Pi, aspect, 1.0f, 1000.0f);
...
CCamera::~CCamera()
{
	if(CamData.ConstBuffer != nullptr)
