...
void CPlayer::CreateShaderVariables(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	UINT ncbElementBytes = d3dUtil::CalcConstantBufferByteSize(sizeof(CB_PLAYER_INFO));
	m_pd3dcbPlayer = d3dUtil::CreateDefaultBuffer(pd3dDevice, pd3dCommandList, nullptr, ncbElementBytes, m_pd3dcbPlayer);
