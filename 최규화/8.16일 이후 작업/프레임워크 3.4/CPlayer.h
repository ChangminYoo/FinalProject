...
public:
	...
	void CreateOtherClientEndBullet(ID3D12Device* Device, ID3D12GraphicsCommandList* cl,const Position3D& Goal, CGameObject* lock, list<CGameObject*>* bulletlist, const STC_BulletObject_EndPos_Info& server_endbulldata);
	void CreateOtherClientEndDicestrikeSkill(ID3D12Device* Device, ID3D12GraphicsCommandList* cl,const Position3D& Goal, CGameObject* lock, list<CGameObject*>* bulletlist,  const STC_BulletObject_EndPos_Info& server_endbulldata, const XMFLOAT3& OffLookvector);
