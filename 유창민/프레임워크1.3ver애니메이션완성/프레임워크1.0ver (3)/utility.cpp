...
//오브젝트는 다수의 애니메이션을 가질수있음. 맨뒤의 인자는 몇번째 애니메이션을 쓸건지를 나타낸다.
void UpdateMD5Model(ID3D12GraphicsCommandList* m_DC, CMesh*& MD5Model, CGameObject* obj, float deltaTime, int animation, vector<ModelAnimation>& av, float scale)
{
