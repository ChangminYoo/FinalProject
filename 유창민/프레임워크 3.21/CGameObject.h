...
{
public:
	TowerObject(ID3D12Device* m_Device, ID3D12GraphicsCommandList* commandlist, list<CGameObject*>*Plist, list<CGameObject*>*shadow, float dgree, XMFLOAT4 cp = XMFLOAT4(0, 0, 0, 0));
	~TowerObject();
	ShadowObject* s = NULL;
public:
	static CMaterial Mat;
